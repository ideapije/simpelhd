...
//CI_Controller {
	...
	public function cetak_kk($id_keluarga)
	{
		...
		$data['data_keluarga_1'] = $this->kependudukan->get_kependudukan_1($id_keluarga);
	...
	public function simpan_keluarga()
	{
		...
		$person = $this->db->get_where('person', array('nik'=>$this->input->post('nik_kepkel')))->row();
		...
		$data = array(
			...
			'jumlah_angkel' 	=> $this->input->post('jumlah_angkel'),
		...
		$this->Keluarga->tambah('keluarga', $data);
