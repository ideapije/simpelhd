...
class Keluarga extends MY_Model
{
	public function tambah()
	{
		...
		$this->submit_anggota_keluarga('tambah_ayah', $id_keluarga, $this->input->post('no_kk'), $this->input->post('nik_kepkel'));
	}
	...
	public function submit_anggota_keluarga($status, $id_keluarga="", $no_kk="", $nik_kepkel="")
	{
		if($status == "tambah_ayah")
		{
			$data = array(
						"nik" 	=> $nik_kepkel
				);
			$data_person = $this->db->get_where('person', array('nik'=>$nik_kepkel));
